...
export class PoolSnapshot {
  ...
  @Column('decimal', { precision: 20, scale: 7, nullable: true, transformer: decimalTransformer })
  priceAUsd: string | null;

  @Column('decimal', { precision: 20, scale: 7, nullable: true, transformer: decimalTransformer })
  priceBUsd: string | null;

  @Column('decimal', { precision: 20, scale: 2, nullable: true, transformer: decimalTransformer })
  tvlUsd: string | null;
