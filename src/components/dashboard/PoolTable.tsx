...
function TokenAvatar({ code }: { code: string }) {
  return (
    <div
      className="flex size-8 shrink-0 items-center justify-center rounded-full text-white shadow-inner ring-2 ring-[#111827]"
      style={{ backgroundColor: tokenBg(code) }}
      title={code}
    >
      <svg className="size-4 opacity-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
